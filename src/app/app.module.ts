...
} from './admin/adminevenements/add/add.component';
import {
  EditEvenementComponent
} from './admin/adminevenements/edit/edit.component';
import {
  NgxPaginationModule
} from 'ngx-pagination';
import {
  AdminEvenementsComponent
} from './admin/adminevenements/evenements.component';
import {
  NgModule
} from '@angular/core';
import {
...
import {
  NavbarComponent
} from './includes/navbar/navbar.component';
import {
  MaincontentComponent
} from './main-content/maincontent/maincontent.component';
import {
  HistoriqueComponent
} from './administration/historique/historique.component';
import {
  FooterComponent
} from './includes/footer/footer.component';
import {
  ContactComponent
...
import {
  HomeComponent
} from './admin/home/home.component';
import {
  InterceptorService
} from './services/interceptor.service';
import {
  CreationsComponent
} from './admin/creations/creations.component';
import {
  AddComponent
} from './admin/creations/add/add.component';
import {
  EditComponent
} from './admin/creations/edit/edit.component';
import {
  LoaderComponent
} from './includes/loader/loader.component';
import {
  ModalComponent
} from './includes/modals/modals.component';
import {
  BijouxComponent
} from './creations/bijoux/bijoux.component';
import {
  SortPipe
